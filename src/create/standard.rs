...
pub fn create_gma_with_done_callback(dir: &str, w: &mut impl Write, done_callback: fn()) -> Result<(), std::io::Error> {
...
pub fn create_gma(dir: &str, w: &mut impl Write) -> Result<(), std::io::Error> {
